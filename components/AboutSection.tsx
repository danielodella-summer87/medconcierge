...
import teamImage from "@/public/images/nosotros-equipo.jpg";
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <p className="mt-4 text-base leading-relaxed text-slate-600 sm:text-lg">
              ...
              Uruguay, trabajamos junto a profesionales de la salud para
              brindar acompañamiento integral, seguro y humano en cada etapa
              del proceso médico.
            </p>
          </div>

          <div className="relative h-64 overflow-hidden rounded-2xl shadow-sm ring-1 ring-slate-200 lg:h-72">
            <Image
              src={teamImage}
              alt="Profesional de salud de MedConcierge"
              fill
              placeholder="blur"
